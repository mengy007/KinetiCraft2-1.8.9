...
public class EntityKC2Treadmill extends Entity {
    ...
    public void onUpdate() {
        super.onUpdate();
        if (!(this.worldObj.getBlockState(new BlockPos(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ))).getBlock() instanceof BlockKC2Treadmill)) this.kill();
    }
